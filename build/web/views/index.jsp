...
<html>
	...
	<link rel="stylesheet" href="webroot/css/style2.css" type="text/css" media="all" />
	<!--<script type="text/javascript" src="webroot/js/jquery.min.js"></script>-->
        <script type="text/javascript" src="webroot/js/jquery-1.6.2.min.js"></script>
	<script type="text/javascript" src="webroot/js/jquery.jcarousel.min.js"></script>
	<!--[if IE 6]>
		<script type="text/javascript" src="js/png-fix.js"></script>
	<![endif]-->
	<script type="text/javascript" src="webroot/js/functions.js"></script>
    </head>
    <body>
	<!-- Header -->
	<div id="header" class="shell">
		...
		<div id="navigation">
			<ul>
				...
				<li><s:a href="%{lien1}">Produits</s:a></li>
		...
		<div id="login-details">
			<p>Welcome, <a href="#" id="user">Guest</a> .</p><p><a href="#" class="cart" ><img src="webroot/images/cart-icon.png" alt="" /></a>Shopping Cart (0) <a href="#" class="sum">$0.00</a></p>
		</div>
		<!-- End Login-details -->
	</div>
	<!-- End Header -->
	...
	<div id="slider">
		<div class="shell">
			<ul>
				<li>
					<div class="image">
						<img src="webroot/images/books.png" alt="" />
					</div>
					<div class="details">
						<h2>Bestsellers</h2>
				...
				<ul>
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image01.jpg" alt="" />
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image02.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image03.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image04.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image05.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image06.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image07.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
					...
					<li>
						<div class="product">
							<a href="#" class="info">
								<span class="holder">
									<img src="webroot/images/image08.jpg" alt="" />
									<span class="book-name">Book Name</span>
									<span class="author">by John Smith</span>
									<span class="description">Maecenas vehicula ante eu enim pharetra<br />scelerisque dignissim <br />sollicitudin nisi</span>
								</span>
			...
			<div id="best-sellers">
				...
				<ul>
					<li>
						<div class="product">
							<a href="#">
								<img src="webroot/images/image-best01.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="webroot/images/image-best02.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="webroot/images/image-best03.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
					...
					<li>
						<div class="product">
							<a href="#">
								<img src="webroot/images/image-best04.jpg" alt="" />
								<span class="book-name">Book Name </span>
								<span class="author">by John Smith</span>
