                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="index.php/Liste/montantrecu">Montant billet reçu</a>
                                </li>
                                <li>
                                    <a href="index.php/Liste/montantreste">Montant reste à payé</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
